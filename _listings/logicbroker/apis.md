...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/base/master/_listings/logicbroker/apis.md
...
- name: CommerceAPI - Create shipment(s) based on custom XML.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/base/master/_listings/logicbroker/apiv1shipmentscustomxml-post-openapi.md
- name: CommerceAPI - Create return(s) based on custom XML.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/base/master/_listings/logicbroker/apiv1returnscustomxml-post-openapi.md
- name: CommerceAPI - Create order(s) based on custom XML.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/base/master/_listings/logicbroker/apiv1orderscustomxml-post-openapi.md
- name: CommerceAPI - Get invoices based on provided filters
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/base/master/_listings/logicbroker/apiv1invoices-get-openapi.md
- name: CommerceAPI - Create invoice(s) based on custom XML.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/base/master/_listings/logicbroker/apiv1invoicescustomxml-post-openapi.md
- name: CommerceAPI - Create acknowledgement(s) based on custom XML.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/base/master/_listings/logicbroker/apiv1acknowledgementscustomxml-post-openapi.md
x-common:
- type: x-blog-rss
